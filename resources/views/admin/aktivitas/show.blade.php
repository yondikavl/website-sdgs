    ...
    @endif
      ...
      <div class="card-body">
        <div class="text-center py-3 form-group">
          <label for="ikon_pencapaian" style="cursor: pointer">
            @if ($pencapaian->ikon_pencapaian == Null)
                ...
                <input type="file" class="visually-hidden" name="ikon_pencapaian" id="ikon_pencapaian" disabled>
        ...
        <div class="form-group">
          ...
          <input type="nama_pencapaian" class="form-control @error('nama_pencapaian') is-invalid @enderror" id="nama_pencapaian" value="{{$pencapaian->nama_pencapaian}}" name="nama_pencapaian" disabled>
        ...
        <div class="form-group">
          ...
          <input type="deskripsi_pencapaian" class="form-control @error('deskripsi_pencapaian') is-invalid @enderror" id="deskripsi_pencapaian" value="{{$pencapaian->deskripsi_pencapaian}}" name="deskripsi_pencapaian" disabled>
        ...
        <div class="form-group">
          ...
          <div class="input-group" id="persentase">
            <input type="number" class="form-control @error('persentase') is-invalid @enderror" id="persentase" placeholder="Masukkan persentase pencapaian" name="persentase" required autocomplete="current-persentase" disabled>
