        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="input-group" id="persentase">
              <input type="number" class="form-control @error('persentase') is-invalid @enderror" id="persentase" placeholder="Masukkan persentase aktivitas" name="persentase" required autocomplete="current-persentase" enabled>
