var mymap = L.map('maps').setView([-5.450000, 105.266670], 10);
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    ...
    tileSize: 512,
    zoomOffset: -1,
    accessToken: 'pk.eyJ1Ijoicml2YWxkaTIyMiIsImEiOiJjbHg4bWE2bGMwdnk4MmxzZ3Bsd2VqOHk0In0.EgK94tnBx5E1rbCHIvqa5A'
}).addTo(mymap);
var popup = L.popup();
var longlat = [];
var label = [];
...
if(index===''){
    function onMapClick(e) {
        popup
            .setLatLng(e.latlng)
            .setContent("<center>Sudah yakin dengan letak posisinya?</center><br>Latitude = "+e.latlng.lat+"<br>"+"Longitude = "+e.latlng.lng)
            .openOn(mymap);
